  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      if (userDoc.exists()) {
        ...
        // If user doesn't exist in Firestore, they might need to register first or we auto-assign role
        setError("Account not found. Please register your church first.");
        await auth.signOut();
      }
    } catch (err) {
      setError(err.message);
